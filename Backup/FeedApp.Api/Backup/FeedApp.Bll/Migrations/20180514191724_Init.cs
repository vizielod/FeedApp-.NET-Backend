        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Meal = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaloriesForMaitenance = table.Column<int>(nullable: false),
                    ExerciseLevel = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    EatingId = table.Column<long>(nullable: false),
                    FoodId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodsForEating", x => x.ID);
                    table.ForeignKey(
                        name: "FK_FoodsForEating_Eating_EatingId",
                        column: x => x.EatingId,
                        principalTable: "Eating",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodsForEating_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodsForEating_EatingId",
                table: "FoodsForEating",
                column: "EatingId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodsForEating_FoodId",
                table: "FoodsForEating",
                column: "FoodId");
